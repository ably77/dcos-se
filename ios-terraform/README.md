...
# Install Mesosphere DC/OS Enterprise on AWS
...
Run this command below to have Terraform initialized from this repository. There is **no git clone of this repo required** as Terraform performs this for you. This is a private repository that enforces SSH. Please ensure your permission to this private repository and your machine has the correct access. Reach out to Mesosphere for access and here is github documentation to configure your machine: https://help.github.com/articles/adding-a-new-ssh-key-to-your-github-account/.
...
dcos_cluster_name "Kube-Cassandra Prod"
...
dcos_use_proxy = "yes"
dcos_http_proxy = "127.0.0.1"
dcos_https_proxy = "127.0.0.1"
dcos_no_proxy = <<EOF
# YAML
 - "internal.net"
 - "example.com"
