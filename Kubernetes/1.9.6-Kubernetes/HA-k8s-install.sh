...
dcos package install kubernetes --package-version=1.0.2-1.9.6  --yes --options=options.json
dcos package install kubernetes --cli --yes --package-version=1.0.2-1.9.6
