...
# non-HA Sizing Requirements: 4 Private Agent Nodes / 1 Public Agent
...
dcos package install kubernetes --package-version=1.1.0-1.10.3  --yes --options=kubernetes-proxy/options-nonHA.json
dcos package install kubernetes --cli --yes --package-version=1.1.0-1.10.3
dcos package install marathon-lb --yes
dcos marathon app add kubernetes-proxy/kubectl-proxy-ssl.json
